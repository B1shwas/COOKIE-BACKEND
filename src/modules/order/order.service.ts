...
import { ORDER_STATUS, PAYMENT_STATUS } from "./enum/order.enum";
...
export class OrderService {
  ...
  async createOrder(
    ...
    try {
      ...
      if (paymentMethod === "ESEWA" && !paymentInfo) {
        throw new BadRequestException("Payment info required for ESEWA");
      }
      if (paymentMethod === "CASH_ON_DELIVERY" && paymentInfo) {
